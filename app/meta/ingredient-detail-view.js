...
module.exports = ['detailViewConstructor', 'formFieldConstructor', '$timeout', '$http', function(DetailView, FormField, $timeout, $http){
    ...
    return new DetailView({
        ...
        carbs: new FormField().labelAs('Carbs').asSlider({ min: 0, max: 100 }),
        fats: new FormField().labelAs('Fats').asSlider({ min: 0, max: 100 }),
        protein: new FormField().labelAs('Protein').asSlider({ min: 0, max: 100 }),
